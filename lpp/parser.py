...
class Parser:
    ...
    def _parse_expression(self, precedence: Precedence) -> Optional[Expression]:
        ...
        try:
            ...
            error = f'No se encontró una función para parsear {self._current_token.literal}'
            self._errors.append(error)
            return None
    ...
    def _parse_integer(self) -> Optional[Integer]:
        ...
        try:
            ...
            message = f'No se ha podido convertir \'{self._current_token.literal}\' a entero'
    ...
    def _register_infix_fns(self) -> InfixParseFns:
        return {
                ...
                TokenType.LT_OR_EQ: self._parse_infix_expression,
                TokenType.GT: self._parse_infix_expression,
                TokenType.GT_OR_EQ: self._parse_infix_expression,
